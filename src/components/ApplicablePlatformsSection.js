...
import { MessageSquare, Image, Video, Palette, Brain, Code } from 'lucide-react';
      ...
      <div className="max-w-screen-xl mx-auto px-6">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {applicablePlatforms.map((platform) => (
            <Card key={platform.titleKey} className="text-center hover:shadow-lg transition-shadow">
