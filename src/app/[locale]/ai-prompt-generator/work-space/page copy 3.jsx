...
export default function WorkSpacePage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 p-4 h-[calc(100vh-67px)]">
      {/* Left Column: Input Panel */}
      <div className="w-full lg:w-2/5 h-full overflow-y-auto pr-2 space-y-6">
      ...
      <div className="w-full lg:w-3/5 h-full overflow-y-auto pl-2">
        {isLoading ? (
